...
- `03_step_by_step_runs_dynamic_control.py` is intentionally honest about the `0.0.9` boundary: step timing is available, while live `step.get` / `step.set` control is future work.

...
def _plot_notebook(model) -> dict:
    ...
    timeseries_options = [
        ...
        ["`time_format`", "`'datetime' | 'clock' | 'elapsed'`", "`'datetime'`", "Use full date-time labels, hour-minute labels, or elapsed hours; x-axis tick labels are rotated 45 degrees for readability."],

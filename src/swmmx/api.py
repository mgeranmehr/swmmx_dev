...
class SWMMModel:
    ...
    def _get_parameter(self, spec: ParameterSpec, *, ids=None, format=None):
        ...
        if field is None:
            raise NotImplementedYetError(
                f"Structured access for '{spec.path}' is not implemented yet."
            )
    ...
    def _set_parameter(self, spec: ParameterSpec, *, value, ids=None):
        ...
        if field is None:
            raise NotImplementedYetError(
                f"Structured setting for '{spec.path}' is not implemented yet."
            )
    ...
    def _get_derived_parameter(self, spec: ParameterSpec, *, ids=None, format=None):
        ...
        raise NotImplementedYetError(
            f"Derived computation for '{spec.path}' is not implemented yet."
        )

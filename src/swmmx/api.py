...
class SWMMModel:
    ...
    def _ids_for_category(self, category: str) -> list[str]:
        ...
        if sections is None:
            raise NotImplementedYetError(
                f"Object indexing for '{category}' is not implemented in version 0.0.10."
            )
        ids: list[str] = []
    ...
    def _get_parameter(self, spec: ParameterSpec, *, ids=None, format=None):
        ...
        if spec.source_kind == "mixed":
            raise NotImplementedYetError(
                f"'{spec.path}' has mixed source semantics and is not exposed in version 0.0.10."
            )
        ...
        if field is None:
            raise NotImplementedYetError(
                f"Structured access for '{spec.path}' is not implemented in version 0.0.10."
            )
    ...
    def _set_parameter(self, spec: ParameterSpec, *, value, ids=None):
        ...
        if field is None:
            raise NotImplementedYetError(
                f"Structured setting for '{spec.path}' is not implemented in version 0.0.10."
            )
    ...
    def _get_option_parameter(self, spec: ParameterSpec):
        ...
        if option_key is None:
            raise NotImplementedYetError(
                f"Option mapping for '{spec.path}' is not implemented in version 0.0.10."
            )
    ...
    def _get_derived_parameter(self, spec: ParameterSpec, *, ids=None, format=None):
        ...
        raise NotImplementedYetError(
            f"Derived computation for '{spec.path}' is not implemented in version 0.0.10."
        )
    ...
    def _get_result_parameter(self, spec: ParameterSpec, *, ids=None, format=None):
        ...
        if object_kind is None:
            raise NotImplementedYetError(
                f"Result access for '{spec.path}' is not implemented in version 0.0.10."
            )
